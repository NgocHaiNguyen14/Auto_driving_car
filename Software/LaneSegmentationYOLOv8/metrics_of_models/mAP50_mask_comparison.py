...
mask_p1 = df1['Mask(mAP50)']
mask_p2 = df2['Mask(mAP50)']
mask_p3 = df3['Mask(mAP50)']
mask_p4 = [0.895, 0.902, 0.878, 0.915] 
...
plt.title('Comparison of Mask(mAP50) Across Models')
...
plt.savefig('mask_mAP50_comparison.png')
