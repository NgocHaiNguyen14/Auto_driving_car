...
# Print the results
print(f"Front1 - Lane pixels: {front1_lane_count}, Marking pixels: {front1_marking_count}")
print(f"Front2 - Lane pixels: {front2_lane_count}, Marking pixels: {front2_marking_count}")
print(f"Right - Lane pixels: {right_lane_count}, Marking pixels: {right_marking_count}")
print(f"Left - Lane pixels: {left_lane_count}, Marking pixels: {left_marking_count}")
